...
--AUTOINCREMENT CODIGO BARRA
CREATE SEQUENCE SEQ_CODIGO_BARRA
START WITH 1
INCREMENT BY 1;

CREATE OR REPLACE TRIGGER TRIG_CODIGO_BARRA
BEFORE INSERT ON CODIGO_BARRA
FOR EACH ROW
BEGIN
SELECT SEQ_CODIGO_BARRA.NEXTVAL INTO :NEW.IDCODIGO_BARRA FROM DUAL;
END;
/
...
--pendiente de ejecución en Oracle
--AUTOINCREMENT FAMILIA_PRODUCTO
CREATE SEQUENCE SEQ_FAMILIA
START WITH 1
INCREMENT BY 1;

CREATE OR REPLACE TRIGGER TRIG_FAMILIA
BEFORE INSERT ON FAMILIA_PRODUCTO
FOR EACH ROW
BEGIN
SELECT SEQ_FAMILIA.NEXTVAL INTO :NEW.IDFAMILIA_PRODUCTO FROM DUAL;
END;
/
commit;
...
CREATE OR REPLACE TRIGGER TRIG_TIPO_PRODUCTO
BEFORE INSERT ON TIPO_PRODUCTO
FOR EACH ROW
BEGIN
SELECT SEQ_TIPO_PRODUCTO.NEXTVAL INTO :NEW.IDTIPO_PRODUCTO FROM DUAL;
END;
/
commit;
...
CREATE OR REPLACE TRIGGER TRIG_MARCA
BEFORE INSERT ON MARCA
FOR EACH ROW
BEGIN
SELECT SEQ_MARCA.NEXTVAL INTO :NEW.IDMARCA FROM DUAL;
END;
/
commit;
