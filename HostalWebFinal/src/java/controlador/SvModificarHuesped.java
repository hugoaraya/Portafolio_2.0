...
import static dao.HuespedDAO.modificarHuesped;
 ...
 */
@WebServlet(name = "SvModificarHuesped", urlPatterns = {"/modificarHuesped"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           int estado_huesped_id = Integer.parseInt(request.getParameter("id_estado_huesped"));
            ...
            if(huesp != null){
             modificarHuesped(idhuesped, nombre_huesped, apellido_huesped, telefono, correo, cargo,idempresa,estado_huesped_id); 
