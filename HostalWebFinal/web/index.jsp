...
<body>
	<header class="header" id="top">
		<div class="contenedor">
			<h1 class="logo">Hostal Clarita</h1>
                        <span class="icon-menu" id="btn-menu"><img src='img/boton.png'></span>
			<nav class="nav" id="nav">
				<ul class="menu">
					<li class="menu__item"><a class="menu__link select" href="">Inicio</a></li>
                                        <li class="menu__item"><a class="menu__link" href="habitaciones.jsp">Habitaciones</a></li>
	...
	<main class="main">
		...
		<section class="juguetes" id="juguetes">
